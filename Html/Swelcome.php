...
<head>
	...
	<title>
		...
		<link rel="stylesheet" href="../Css/Swelcome.css">
...
<body>
	...
	<div class="header">
		...
		<center>
			<h1><font size = "50px" color = "red" >Welcome To the Staff Page...!</font></h1>
           <br>
		   <br>
		<font size = "7px">
        ...
        <?php
            ...
            $sql = "SELECT username, email, staff_id FROM staff WHERE username='".$_SESSION['username']."'";
            ...
            if (mysqli_num_rows($result) == 1) {
                while($row = mysqli_fetch_assoc($result)) {
                    ...
                    <h1>Staff ID: <?php echo $row['staff_id'];?></h1>
					</div>
                    <?php
                }
...
<br>
<br>
			<button class="btn" type="button" ><a href = "updatestaff.php">Edit Profile</button></a>
<br>
<br>
		<!--footer--->
